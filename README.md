...
_<sup>*</sup> Why? .. as a child of the eighties i grew up with computers and console games that didn't have dedicated 3d hardware. at that time most games consisted of 2d-sprites, 2d-levels with parallax effects and sprites that simulated a 3d environment (also known as 2.5d) - already at that time I wanted to be able to program something like that, but somehow I was kept from .._<sup>***</sup>
