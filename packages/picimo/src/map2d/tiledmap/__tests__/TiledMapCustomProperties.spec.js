...
describe('TiledMapCustomProperties', () => {
  ...
  it('foo', () =>
    assert.deepStrictEqual(props.valueAsCSLofStrings('foo'), [
      'abc',
      'def',
      'ghi',
    ]));
  ...
  it('bar', () =>
    assert.deepStrictEqual(props.valueAsCSLofStrings('bar'), [
      `x" x`,
      `y`,
      `ghi, klo`,
    ]));
  ...
  it('plah', () =>
    assert.deepStrictEqual(props.valueAsCSLofStrings('plah'), [
      'abc',
      'def',
      'ghi',
      'jkl',
  ...
  it('zero', () =>
    assert.strictEqual(props.valueAsCSLofStrings('zero'), undefined));
});
