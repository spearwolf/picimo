...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "blitpunk-dev." + ({"0":"document-register-element","1":"safari","2":"modern","3":"legacy"}[chunkId]||chunkId) + "." + {"0":"789c8ae9eed6527f8176","1":"649f2296249a98bf2986","2":"cf53194fea3f56e5f608","3":"7691027b0847ad5eeaff"}[chunkId] + ".js";
...
/******/ 	__webpack_require__.p = "/blitpunk/dev/";
/******/
...
var _detectCustomElements = __webpack_require__(329);

var _detectCustomElements2 = _interopRequireDefault(_detectCustomElements);

var _detectJavascriptVariant = __webpack_require__(331);
...
(0, _log2.default)('blitpunk bootstrap (' + "development" + ')', 'javascriptVariant=', javascriptVariant, 'needsCustomElementsPolyfill=', needsCustomElementsPolyfill);

var loadPolyfills = needsCustomElementsPolyfill ? __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 337)).then(function () {
  (0, _log2.default)('loaded polyfill: customElements');
}) : Promise.resolve();

var loadApi = function loadApi() {
  return __webpack_require__(333).default(javascriptVariant).then(function (_ref) {
    var initialize = _ref.default;
    return initialize();
  }).then(function (api) {
    var globalApi = global && global.BLITPUNK;
    if (globalApi) {
...
var preLoad = loadPolyfills.then(loadApi);
...
exports.__esModule = true;
var bowser = __webpack_require__(124);
...
exports.default = function (javascriptVariant) {
  ...
  switch (javascriptVariant) {
    case 'modern':
      jsImport = __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 334));
      break;
    case 'safari':
      jsImport = __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 335));
      break;
    default:
      jsImport = __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 336));
  }
  return jsImport;
};
