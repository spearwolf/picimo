...
log('blitpunk bootstrap (' + "production" + ')', 'isModernJavascript=', isModernJavascript, 'needsCustomElementsPolyfill=', needsCustomElementsPolyfill);
...
var loadBlitpunk = function loadBlitpunk() {
  ...
  var jsFile = 'blitpunk' + ( false ? '-dev' : '') + '-' + variant + '.js';
  log('fetching', jsFile);
